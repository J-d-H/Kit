...
var kitt: HTMLDivElement = null;
var dataPath: string = null;
var myProcess: NodeJS.Process = null;
...
function spawnGit(parameters : string[], dir: string, callback: (code: number, std: string)=>any, retrynum = 0) {
	var params = '';
...
function findSubmodules(dir: string, callback: (modules: any[]) => any) {
...
function pull(projectsDir: string, dir: string, specials: boolean, callback: () => any) {
...
export function init(aKitt: HTMLDivElement, aProcess: NodeJS.Process, aDataPath: string): void {
	kitt = aKitt;
	myProcess = aProcess;
	dataPath = aDataPath;
}

export function update(repo, repos, projectsDir: string, callback: () => any) {
